...
export const demo = {
    ...
    delegation: {
        delegatedSupport: () => token({ iss: "corp-idp", sub: "carol", tenant: "acme", role: "admin", acr: "mfa", delegated: true, actor: "support-agent", authzVersion: 21 }),
        directViewer: () => token({ iss: "corp-idp", sub: "carol", tenant: "acme", role: "viewer", acr: "mfa", delegated: false, authzVersion: 21 })
    },
    revocation: {
...
export function reviewerTokenBundle() {
    return {
